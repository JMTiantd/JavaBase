...
public class Exercise1_10
{
    ...
    {
        /**
         * 7 2.0E-6 200.0000002 true true
         */
        ...
        /**
         * e的相关用法 true true false 1.0E-12 9.999999999999999E-6
         */
        System.out.println("-------------------------");
        ...
        /**
         * &&或者||的用法 true true false false true true
         */
        System.out.println("-----------------");
    ...
    /**
     * 1.1.3 编写一个程序从命令行得到三个整数参数。如果它们都相等则打印 equal，否则打印not equal
     * @author 王武明
    ...
    /**
     * 1.1.5 编写一个程序，如果double类型的变量x和变量y都严格位于0和1之间则打印true，否则打印false
     * @author 王武明
    ...
    public static void ex_1_5(double a, double b)
    {
        ...
        if (ab.compareTo(BigDecimal.ZERO) > 0 && ab.compareTo(new BigDecimal("1")) < 0 && bb.compareTo(BigDecimal.ZERO) > 0
        ...
        else
        {
            ...
            System.out.println(ab.compareTo(new BigDecimal("1")));
            System.out.println(bb.compareTo(BigDecimal.ZERO));
            System.out.println(bb.compareTo(new BigDecimal("1"))); // 0.999999999999999999999
                                                                   // == 1 ?
            System.out.println(false);
        }
